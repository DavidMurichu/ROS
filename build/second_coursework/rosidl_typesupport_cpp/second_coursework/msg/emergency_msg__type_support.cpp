...
static const _EmergencyMsg_type_support_symbol_names_t _EmergencyMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, second_coursework, msg, EmergencyMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, second_coursework, msg, EmergencyMsg)),
  }
};
...
{
  return &::second_coursework::msg::rosidl_typesupport_cpp::EmergencyMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, second_coursework, msg, EmergencyMsg)() {
  return get_message_type_support_handle<second_coursework::msg::EmergencyMsg>();
}
