...
bool second_coursework__msg__emergency_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("second_coursework.msg._emergency_msg.EmergencyMsg", full_classname_dest, 49) == 0);
  }
  second_coursework__msg__EmergencyMsg * ros_message = _ros_message;
  {  // description
...
{
  /* NOTE(esteve): Call constructor of EmergencyMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("second_coursework.msg._emergency_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EmergencyMsg");
